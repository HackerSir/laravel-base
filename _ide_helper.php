...
namespace {
    ...
    class SemanticForm extends \Laravolt\SemanticForm\Facade{
        ...
        public static function setOldInputProvider($oldInputProvider){
            return \Laravolt\SemanticForm\SemanticForm::setOldInputProvider($oldInputProvider);
        }
        ...
        public static function setErrorStore($errorStore){
            return \Laravolt\SemanticForm\SemanticForm::setErrorStore($errorStore);
        }
        ...
        public static function setToken($token){
            return \Laravolt\SemanticForm\SemanticForm::setToken($token);
        }
        ...
        public static function open(){
            return \Laravolt\SemanticForm\SemanticForm::open();
        }
         ...
         */
        public static function close(){
            return \Laravolt\SemanticForm\SemanticForm::close();
        }
        ...
        public static function text($name, $defaultValue = null){
            return \Laravolt\SemanticForm\SemanticForm::text($name, $defaultValue);
        }
        ...
        public static function date($name, $defaultValue = null){
            return \Laravolt\SemanticForm\SemanticForm::date($name, $defaultValue);
        }
        ...
        public static function email($name, $defaultValue = null){
            return \Laravolt\SemanticForm\SemanticForm::email($name, $defaultValue);
        }
        ...
        public static function hidden($name, $value = null){
            return \Laravolt\SemanticForm\SemanticForm::hidden($name, $value);
        }
        ...
        public static function textarea($name, $defaultValue = null){
            return \Laravolt\SemanticForm\SemanticForm::textarea($name, $defaultValue);
        }
        ...
        public static function password($name){
            return \Laravolt\SemanticForm\SemanticForm::password($name);
        }
        ...
        public static function checkbox($name, $value = 1){
            return \Laravolt\SemanticForm\SemanticForm::checkbox($name, $value);
        }
         ...
         * @static 
         */
        public static function checkboxGroup($name, $options, $checked = array()){
            return \Laravolt\SemanticForm\SemanticForm::checkboxGroup($name, $options, $checked);
        }
        ...
        public static function radio($name, $value = null){
            return \Laravolt\SemanticForm\SemanticForm::radio($name, $value);
        }
        ...
        public static function radioGroup($name, $options, $checked = null){
            return \Laravolt\SemanticForm\SemanticForm::radioGroup($name, $options, $checked);
        }
        ...
        public static function button($value, $name = null){
            return \Laravolt\SemanticForm\SemanticForm::button($value, $name);
        }
        ...
        public static function submit($value = 'Submit'){
            return \Laravolt\SemanticForm\SemanticForm::submit($value);
        }
         ...
         * @static 
         */
        public static function select($name, $options = array(), $defaultValue = null){
            return \Laravolt\SemanticForm\SemanticForm::select($name, $options, $defaultValue);
        }
        ...
        public static function label($label){
            return \Laravolt\SemanticForm\SemanticForm::label($label);
        }
        ...
        public static function file($name){
            return \Laravolt\SemanticForm\SemanticForm::file($name);
        }
         ...
         */
        public static function token(){
            return \Laravolt\SemanticForm\SemanticForm::token();
        }
        ...
        public static function hasError($name){
            return \Laravolt\SemanticForm\SemanticForm::hasError($name);
        }
        ...
        public static function getError($name, $format = null){
            return \Laravolt\SemanticForm\SemanticForm::getError($name, $format);
        }
        ...
        public static function bind($model){
            return \Laravolt\SemanticForm\SemanticForm::bind($model);
        }
        ...
        public static function getValueFor($name){
            return \Laravolt\SemanticForm\SemanticForm::getValueFor($name);
        }
        ...
        public static function selectMonth($name, $format = '%B'){
            return \Laravolt\SemanticForm\SemanticForm::selectMonth($name, $format);
        }
        ...
        public static function selectRange($name, $begin, $end){
            return \Laravolt\SemanticForm\SemanticForm::selectRange($name, $begin, $end);
        }
        ...
        public static function selectDate($name, $beginYear = 1900, $endYear = null){
            return \Laravolt\SemanticForm\SemanticForm::selectDate($name, $beginYear, $endYear);
        }
        ...
        public static function selectDateTime($name, $beginYear = 1900, $endYear = null, $interval = 30){
            return \Laravolt\SemanticForm\SemanticForm::selectDateTime($name, $beginYear, $endYear, $interval);
        }
